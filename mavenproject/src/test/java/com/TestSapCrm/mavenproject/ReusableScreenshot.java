package com.TestSapCrm.mavenproject;
	...
	public class ReusableScreenshot {
	    public void captureScreenshot(String screenshotName,WebDriver driver) throws IOException
		{
			...
			try {
			File dest=new File("C:\\Users\\X0143782\\OneDrive - Applied Materials\\Desktop\\Sap1\\sapcrm\\src\\test\\java\\com\\sapcrm\\Screenshot1"+ "\\TestResults\\" +screenshotName + ".png");
		...
		public void saveScreenshotsToWordDocument(String documentName, String[] screenshotNames) throws IOException, XmlException 
		{
			...
			headerRun.setText("SAP Crm - Regression Test Results");
			headerRun.addBreak();
			...
			//Setting Footer
			String footerText="© 2023. Confidential - Do not Share this documents.";
			...
			for (String file : screenshotNames) {
				...
				try {
						...
						File dest = new File("C:\\Users\\X0143782\\OneDrive - Applied Materials\\Desktop\\Sap1\\sapcrm\\src\\test\\java\\com\\sapcrm\\Screenshot1" + "\\TestResults\\" + file + ".png");
				...
				FileOutputStream out=new FileOutputStream("C:\\Users\\X0143782\\OneDrive - Applied Materials\\Desktop\\Sap1\\sapcrm\\src\\test\\java\\com\\sapcrm\\Screenshot1" + "\\TestResults\\" +  documentName + ".doc");
				doc.write(out);
				out.close();
